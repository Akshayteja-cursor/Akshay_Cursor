...
def combine_extension_lines(df: pd.DataFrame) -> pd.DataFrame:
    ...
    'DIO - AUD - FNC - Mid - Hourly Update' (1,900,000 / 1,995,000) plus
    'DIO - AUD - FNC - Mid - Hourly Update - Extension' (100,000 / 105,000)
    must report as one row with Contracted Quantity 2,000,000 and
    Goal Quantity 2,100,000 running 06/01/2026 - 08/14/2026.
    """
    if df.empty:
        return df
