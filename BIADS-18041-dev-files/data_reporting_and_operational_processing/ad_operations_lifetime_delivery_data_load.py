...
def lifetime_delivery(staq_pacing: str, report_date: datetime) -> pd.DataFrame:
    ...
    try:
        fw_demo_agg = read_fw_demo(ad_ops_pacing_demo, ad_ops_pacing_demo_daily, report_date, monthly=True)
        ...
        fw_demo_agg = read_fw_demo(ad_ops_pacing_demo, ad_ops_pacing_demo_daily, report_date, monthly=True, skiprows=4)
